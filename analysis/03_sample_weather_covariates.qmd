...
```{r}
start_date <- as.POSIXct("2018-06-01 08:00:00", tz="Europe/Stockholm")
end_date <- as.POSIXct("2018-06-08 00:00:00", tz="Europe/Stockholm")
...
```{r}
# --- Plot 1: Scatter of predicted vs true values with R², MAE, RMSE in the title ---
p1 <- ggplot(cv_results_df, aes(x = pred, y = true, color = as.factor(fold))) +
  geom_point(alpha = 0.4) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed", color = "black") +
  labs(
    x = "Predicted Values (°C)",  # Updated axis label
    y = "True Values (°C)",      # Updated axis label
    color = "Fold",
  ...
  scale_color_viridis_d(option = "magma", begin = 0.3) +  # Add magma color scale
  theme_minimal()

p1
ggsave('./figures/kriging_cv.jpg')
```
